...
export class UserProfileController {
    ...
    async asyncgetUserById( @Param('id') id: string ){
        ...
        return {user:user, username:user.username, intraname: user.intraName, profilePicture:user.profilePicture, experience:user.experience, status:OurSession.GetUserState(id)}
    }
