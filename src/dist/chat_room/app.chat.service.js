...
let ChatRoomService = ChatRoomService_1 = class ChatRoomService {
    getPage() {
        return `<button type="button" onclick="loadPage('chat/next')">Increase</button> ${ChatRoomService_1.num.toString()}`;
    }
};
ChatRoomService.num = 5;
ChatRoomService = ChatRoomService_1 = __decorate([
    (0, common_1.Injectable)()
], ChatRoomService);
exports.ChatRoomService = ChatRoomService;
//# sourceMappingURL=app.chat.service.js.map